...
private class SpriteCache(T) : ResourceCache!T {
    ...
    private void loadJson(string file, Texture texture) {
        ...
        foreach (string tag, JSONValue value; sheetJson.object) {
            ...
            sprite.size *= Vec2f(getJsonFloat(value, "scalex", 1f),
                    getJsonFloat(value, "scaley", 1f));
            ...
            Vec2f center = Vec2f(getJsonFloat(value, "centerx", -1f),
                    getJsonFloat(value, "centery", -1f));
            if (center.x > -.5f) //Temp
...
private class TilesetCache(T) : ResourceCache!T {
    ...
    private void loadJson(string file, Texture texture) {
        ...
        foreach (string tag, JSONValue value; sheetJson.object) {
            ...
            tileset.scale = Vec2f(getJsonFloat(value, "scalex", 1f),
                    getJsonFloat(value, "scaley", 1f));
