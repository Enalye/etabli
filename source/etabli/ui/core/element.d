 ...
 * Authors: Enalye
 */
module etabli.ui.core.element;

import etabli.common;
import etabli.core;
import etabli.render;
import etabli.ui.core.manager;
...
class UIElement {
    private {
        ...
        Array!Image _images;
        Array!NativeEventListener[string] _eventListeners;
    ...
    final void removeEventListener(string type, NativeEventListener listener) {
        _eventListeners.update(type, { return new Array!NativeEventListener; },
    ...
    final void dispatchEvent(string type, bool bubbleUp = true) {
        auto p = type in _eventListeners;
        if (p) {
