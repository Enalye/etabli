...
module etabli.ui.gui_overlay;

import std.algorithm.comparison : max;
import etabli.core, etabli.render, etabli.common;
import etabli.ui.gui_element, etabli.ui.label, etabli.ui.text, etabli.ui.gui_manager;

private {
    HintWindow _hintWindow;
    Hint _displayedHint;
    UIElement[] _backupGuis;
    UIElement[] _overlayElements;
...
package(etabli) void processOverlayBack() {
    foreach (gui; _backupGuis) {
...
package(etabli) void processOverlayFront(float deltaTime) {
...
private final class HintWindow : UIElement {
    private {
        bool _isRendered;
    }
    Label text;
